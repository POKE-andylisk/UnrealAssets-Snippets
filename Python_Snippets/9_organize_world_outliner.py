# cleans up the world outliner actors in the currently opened level
# places actors into their own folder determined by their actor class type, such as static mesh or blueprint
import unreal
